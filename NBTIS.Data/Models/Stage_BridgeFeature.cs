...
public partial class Stage_BridgeFeature
{
    ...
    public string? FeatureType_BF01 { get; set; }
    ...
    public virtual ICollection<Stage_BridgeRoute> Stage_BridgeRoutes { get; set; } = new List<Stage_BridgeRoute>();
}
