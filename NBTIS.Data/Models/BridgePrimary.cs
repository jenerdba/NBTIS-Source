...
public partial class BridgePrimary
{
    ...
    public virtual ICollection<BridgeFeature> BridgeFeatures { get; set; } = new List<BridgeFeature>();

    public virtual ICollection<BridgeInspection> BridgeInspections { get; set; } = new List<BridgeInspection>();

    public virtual ICollection<BridgePostingEvaluation> BridgePostingEvaluations { get; set; } = new List<BridgePostingEvaluation>();

    public virtual ICollection<BridgePostingStatus> BridgePostingStatuses { get; set; } = new List<BridgePostingStatus>();

    public virtual ICollection<BridgeSpanSet> BridgeSpanSets { get; set; } = new List<BridgeSpanSet>();

    public virtual ICollection<BridgeSubstructureSet> BridgeSubstructureSets { get; set; } = new List<BridgeSubstructureSet>();

    public virtual ICollection<BridgeWork> BridgeWorks { get; set; } = new List<BridgeWork>();
